...
| 迁移自 | [dsh-community-fabric/docs/rfcs/0002-runtime-presentation-invocation-transport.zh.md](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-fabric/docs/rfcs/0002-runtime-presentation-invocation-transport.zh.md) |
...
[RFC 0001](0001-core-contract.md) 有意把实验性 v0.1 限定为单一 Host-side Node.js runtime face。本 RFC 不扩大 v0.1 runtime 范围。Descriptor schema、协议 schema、经过评审的 Control 实现、Transport adapter 与一致性 fixtures 全部存在前，任何实现都不能宣称支持本 RFC。
...
- [RFC 0001：Plugin Manifest、Capability 与事件模型](0001-core-contract.md)
