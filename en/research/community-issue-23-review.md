...
> **Research snapshot — non-normative, not a recommendation. Migrated from [dsh-community-fabric](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-fabric/docs/research/community-issue-23-review.md).**
...
The Fabric documents now absorb those points through a strengthened [RFC 0001](../rfcs/0001-core-contract.md) and three focused follow-up drafts:

- [RFC 0002: Runtime, Presentation, Control, Transport, and Invocation](../rfcs/0002-runtime-presentation.md);
- [RFC 0003: Service Providers and Composition](../rfcs/0003-service-composition.md);
- [RFC 0004: Provenance, Validation, Diagnostics, and the Effect Ledger](../rfcs/0004-provenance-diagnostics.md).
