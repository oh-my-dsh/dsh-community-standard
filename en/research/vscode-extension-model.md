...
> **Research snapshot — non-normative, not a recommendation. Migrated from [dsh-community-fabric](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-fabric/docs/research/vscode-extension-model.md).**
