...
| Migrated from | [dsh-community-fabric/docs/rfcs/0003-service-providers-and-composition.md](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-fabric/docs/rfcs/0003-service-providers-and-composition.md) |
...
This is a design draft, not an API that plugin authors can use today. It extends the model in [RFC 0001](0001-core-contract.md), whose experimental v0.1 runtime remains limited to Host-provided capabilities, lifecycle, `storage.local`, `commands`, and one immutable observation event.
...
- [RFC 0001: Manifest, Capabilities, and Events](0001-core-contract.md).
