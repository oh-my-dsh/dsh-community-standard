...
| Depends on | [RFC 0001](0001-core-contract.md) |
| Community input | [omdsh-dev/community issue #23](https://github.com/omdsh-dev/community/issues/23) |
| Migrated from | [dsh-community-fabric/docs/rfcs/0004-provenance-validation-and-diagnostics.md](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-fabric/docs/rfcs/0004-provenance-validation-and-diagnostics.md) |
...
- [RFC 0001](0001-core-contract.md) owns manifest, negotiation, lifecycle, and basic activation ownership.
- [RFC 0003](0003-service-composition.md) owns service-provider conflict and replacement policy; this RFC records only the resulting runtime transitions as observed effects while decisions remain in the Composition Plan.
- [RFC 0002](0002-runtime-presentation.md) owns invocation and Runtime/Presentation identity; this RFC records opaque identities and redacted outcomes.
...
- [DSH Community Market](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-market/README.md) may display reports but cannot create or upgrade their trust class.
