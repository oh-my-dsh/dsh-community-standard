...
const zhSidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: '视图贡献点', link: '/spec/views' },
      { text: '主题契约', link: '/spec/themes' },
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'views.dsh/v1alpha1', link: '/registry/capabilities/views.dsh-v1alpha1' },
      { text: 'themes.dsh/v1alpha1', link: '/registry/capabilities/themes.dsh-v1alpha1' },
      { text: 'urlstate.dsh/v1alpha1', link: '/registry/capabilities/urlstate.dsh-v1alpha1' },
      { text: 'webseeds.dsh/v1alpha1', link: '/registry/capabilities/webseeds.dsh-v1alpha1' },
    ],
  },
  {
    text: '指南',
