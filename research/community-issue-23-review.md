...
> **调研快照，非规范，不代表推荐。迁移自 [dsh-community-fabric](https://github.com/anywhere-labs/deepseek-harness-desktop/blob/master/dsh-community-fabric/docs/research/community-issue-23-review.zh.md)。**
...
- [RFC 0004：溯源、验证、诊断与 Effect Ledger](../rfcs/0004-provenance-diagnostics.md)。
